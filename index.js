...
let bannedServers = {};
const OWNER_IDS = ["1020868400672686080"]; // Điền ID Discord của bạn vào đây

// Đọc file và dọn dẹp các server bị ban quá 30 ngày (nếu muốn)
...
// ==========================================================
// HỆ THỐNG STREAKS (giống TikTok) - GHÉP TRỰC TIẾP VÀO SOURCE CHÍNH
// Toàn bộ mốc thời gian dùng giờ Việt Nam (Asia/Ho_Chi_Minh)
// ==========================================================

// ---- 1. CÁC MỐC STREAK (29 mốc) ----
const STREAK_TIERS = [
    { key: '0-3',     min: 0,   max: 3,        label: '0–3 ngày' },
    { key: '4-7',     min: 4,   max: 7,        label: '4–7 ngày' },
    { key: '8-11',    min: 8,   max: 11,       label: '8–11 ngày' },
    { key: '12-15',   min: 12,  max: 15,       label: '12–15 ngày' },
    { key: '16-20',   min: 16,  max: 20,       label: '16–20 ngày' },
    { key: '21-25',   min: 21,  max: 25,       label: '21–25 ngày' },
    { key: '26-30',   min: 26,  max: 30,       label: '26–30 ngày' },
    { key: '31-36',   min: 31,  max: 36,       label: '31–36 ngày' },
    { key: '37-42',   min: 37,  max: 42,       label: '37–42 ngày' },
    { key: '43-48',   min: 43,  max: 48,       label: '43–48 ngày' },
    { key: '49-55',   min: 49,  max: 55,       label: '49–55 ngày' },
    { key: '56-62',   min: 56,  max: 62,       label: '56–62 ngày' },
    { key: '63-70',   min: 63,  max: 70,       label: '63–70 ngày' },
    { key: '71-78',   min: 71,  max: 78,       label: '71–78 ngày' },
    { key: '79-87',   min: 79,  max: 87,       label: '79–87 ngày' },
    { key: '88-96',   min: 88,  max: 96,       label: '88–96 ngày' },
    { key: '97-105',  min: 97,  max: 105,      label: '97–105 ngày' },
    { key: '106-115', min: 106, max: 115,      label: '106–115 ngày' },
    { key: '116-125', min: 116, max: 125,      label: '116–125 ngày' },
    { key: '126-135', min: 126, max: 135,      label: '126–135 ngày' },
    { key: '136-145', min: 136, max: 145,      label: '136–145 ngày' },
    { key: '146-160', min: 146, max: 160,      label: '146–160 ngày' },
    { key: '161-175', min: 161, max: 175,      label: '161–175 ngày' },
    { key: '176-190', min: 176, max: 190,      label: '176–190 ngày' },
    { key: '191-210', min: 191, max: 210,      label: '191–210 ngày' },
    { key: '211-230', min: 211, max: 230,      label: '211–230 ngày' },
    { key: '231-250', min: 231, max: 250,      label: '231–250 ngày' },
    { key: '251-275', min: 251, max: 275,      label: '251–275 ngày' },
    { key: '276-300', min: 276, max: Infinity, label: '276–300+ ngày' },
];
...
// ---- ẢNH MẶC ĐỊNH CHO TỪNG MỐC STREAK (điền link ảnh của bạn vào đây) ----
// Chỉ cần sửa trực tiếp trong source, KHÔNG cấu hình qua lệnh /setup-streeks.
const STREAK_TIER_IMAGES = {
    '0-3':     'https://raw.githubusercontent.com/Naknohack/Streek/refs/heads/main/01.png',
    '4-7':     'https://raw.githubusercontent.com/Naknohack/Streek/refs/heads/main/02.png',
    '8-11':    'https://raw.githubusercontent.com/Naknohack/Streek/refs/heads/main/03.png',
    '12-15':   'https://raw.githubusercontent.com/Naknohack/Streek/refs/heads/main/04.png',
    '16-20':   'https://raw.githubusercontent.com/Naknohack/Streek/refs/heads/main/05.png',
    '21-25':   'https://raw.githubusercontent.com/Naknohack/Streek/refs/heads/main/06.png',
    '26-30':   'https://raw.githubusercontent.com/Naknohack/Streek/refs/heads/main/07.png',
    '31-36':   'https://raw.githubusercontent.com/Naknohack/Streek/refs/heads/main/08.png',
    '37-42':   'https://raw.githubusercontent.com/Naknohack/Streek/refs/heads/main/09.png',
    '43-48':   'https://raw.githubusercontent.com/Naknohack/Streek/refs/heads/main/10.png',
    '49-55':   'https://raw.githubusercontent.com/Naknohack/Streek/refs/heads/main/11.png',
    '56-62':   'https://raw.githubusercontent.com/Naknohack/Streek/refs/heads/main/12.png',
    '63-70':   'https://raw.githubusercontent.com/Naknohack/Streek/refs/heads/main/13.png',
    '71-78':   'https://raw.githubusercontent.com/Naknohack/Streek/refs/heads/main/14.png',
    '79-87':   'https://raw.githubusercontent.com/Naknohack/Streek/refs/heads/main/15.png',
    '88-96':   'https://raw.githubusercontent.com/Naknohack/Streek/refs/heads/main/16.png',
    '97-105':  'https://raw.githubusercontent.com/Naknohack/Streek/refs/heads/main/17.png',
    '106-115': 'https://raw.githubusercontent.com/Naknohack/Streek/refs/heads/main/18.png',
    '116-125': 'https://raw.githubusercontent.com/Naknohack/Streek/refs/heads/main/19.png',
    '126-135': 'https://raw.githubusercontent.com/Naknohack/Streek/refs/heads/main/20.png',
    '136-145': 'https://raw.githubusercontent.com/Naknohack/Streek/refs/heads/main/21.png',
    '146-160': 'https://raw.githubusercontent.com/Naknohack/Streek/refs/heads/main/22.png',
    '161-175': 'https://raw.githubusercontent.com/Naknohack/Streek/refs/heads/main/23.png',
    '176-190': 'https://raw.githubusercontent.com/Naknohack/Streek/refs/heads/main/24.png',
    '191-210': 'https://raw.githubusercontent.com/Naknohack/Streek/refs/heads/main/25.png',
    '211-230': 'https://raw.githubusercontent.com/Naknohack/Streek/refs/heads/main/26.png',
    '231-250': 'https://raw.githubusercontent.com/Naknohack/Streek/refs/heads/main/27.png',
    '251-275': 'https://raw.githubusercontent.com/Naknohack/Streek/refs/heads/main/28.png',
    '276-300': 'https://raw.githubusercontent.com/Naknohack/Streek/refs/heads/main/29.png',
};

// ---- 2. LƯU TRỮ DỮ LIỆU STREAKS (file JSON riêng, không đụng database.json chính) ----
const STREAKS_DB_FILE = './streaks_database.json';
let sdb = { guilds: {} };

if (fs.existsSync(STREAKS_DB_FILE)) {
    try { sdb = JSON.parse(fs.readFileSync(STREAKS_DB_FILE, 'utf8')); } catch { sdb = { guilds: {} }; }
}
if (!sdb.guilds) sdb.guilds = {};

function saveStreaksData() {
    fs.writeFileSync(STREAKS_DB_FILE, JSON.stringify(sdb, null, 4), 'utf8');
}

function getStreakGuild(guildId) {
    if (!sdb.guilds[guildId]) {
        sdb.guilds[guildId] = {
            roleMap: {},   // { tierKey: roleId }
            groups: {}     // { code: groupObj }
        };
        saveStreaksData();
    }
    const g = sdb.guilds[guildId];
    if (!g.roleMap) g.roleMap = {};
    if (!g.groups) g.groups = {};
    return g;
}

// Lấy ngày hiện tại theo giờ Việt Nam, dạng "YYYY-MM-DD" (dùng để xác định "qua 0h đêm")
...
function genGroupCode(guildId) {
    const g = getStreakGuild(guildId);
    let code;
    do {
...
// Tìm tất cả nhóm (ở mọi server) mà 1 user đang tham gia
function findUserGroups(userId) {
    const results = [];
    for (const guildId of Object.keys(sdb.guilds)) {
        const g = sdb.guilds[guildId];
        for (const code of Object.keys(g.groups)) {
            const grp = g.groups[code];
            if (grp.members.includes(userId)) results.push({ guildId, code, group: grp });
        }
    }
    return results;
}

// ---- 3. SLASH COMMANDS CỦA HỆ THỐNG STREAKS ----
const streaksSlashCommands = [
    {
        name: 'setup-streeks',
        description: '[Owner server] Gán role muốn trao khi đạt 1 mốc streak',
        default_member_permissions: String(PermissionsBitField.Flags.Administrator),
        options: [
            {
                name: 'role',
                description: 'Role muốn trao khi đạt mốc streak này',
                type: ApplicationCommandOptionType.Role,
                required: true
            },
            {
                name: 'streek',
                description: 'Chọn mốc streak cần gán role',
    ...
    {
        name: 'streak-request',
        description: 'Tạo lời mời lập nhóm Streaks (tối thiểu 2 người tham gia)',
        options: [
            { name: 'name', description: 'Tên nhóm streak', type: ApplicationCommandOptionType.String, required: true }
        ]
    },
    {
        name: 'watch-stalkers',
        description: 'Xem các nhóm streak bạn đang tham gia',
        options: [
            {
                name: 'groups',
                description: 'Chọn nhóm muốn xem chi tiết',
                type: ApplicationCommandOptionType.String,
                required: true,
                autocomplete: true
            }
    ...
    },
    {
        ...
        description: 'Rời khỏi 1 nhóm streak',
        options: [
            {
                name: 'group',
                description: 'Chọn nhóm muốn rời',
                type: ApplicationCommandOptionType.String,
                required: true,
                autocomplete: true
            }
    ...
    {
        name: 'join-group',
        description: 'Tham gia 1 nhóm streak bằng mã mời',
        options: [
            { name: 'code', description: 'Mã mời gồm 8 chữ số', type: ApplicationCommandOptionType.String, required: true }
        ]
    }
];

// ---- 4. GÁN / GỠ ROLE THEO MỐC STREAK ----
async function applyTierRole(guild, guildStreakData, memberId, newStreak) {
    const newTier = tierForStreak(newStreak);
    const newRoleId = guildStreakData.roleMap[newTier.key];

    const allTierRoleIds = STREAK_TIERS.map(t => guildStreakData.roleMap[t.key]).filter(Boolean);
    try {
        const member = await guild.members.fetch(memberId).catch(() => null);
        if (!member) return;
        const toRemove = allTierRoleIds.filter(rid => rid !== newRoleId && member.roles.cache.has(rid));
        ...
        console.error('[Streaks] Lỗi gán role mốc streak:', e.message);
    }
}

// ---- 5. EMBED HIỂN THỊ NHÓM ----
function buildGroupEmbed(group, code) {
    const tier = tierForStreak(group.streak);
    const embed = new EmbedBuilder()
        .setColor('#ff5c8a')
        .setTitle(`🔥 ${group.name}`)
        .setDescription(
            `**Chuỗi hiện tại:** ${group.streak} ngày (${tier.label})\n` +
            `**Mã mời nhóm:** \`${code}\`\n` +
            `**Thành viên (${group.members.length}):** ${group.members.map(id => `<@${id}>`).join(', ')}`
        )
        .setFooter({ text: 'Tất cả thành viên phải nhắn tin + tag nhau và được rep lại tag trước 0h đêm để giữ chuỗi' });

    const img = group.avatar || STREAK_TIER_IMAGES[tier.key];
    if (img) embed.setThumbnail(img);
    return embed;
}

// ---- 6. KHỞI TẠO TOÀN BỘ LISTENER CỦA HỆ THỐNG STREAKS ----
function initStreaks(client) {

    // 6.1: Theo dõi tin nhắn tag qua lại trong ngày (giờ Việt Nam)
    client.on('messageCreate', async (message) => {
        try {
            if (message.author.bot || !message.guild) return;
            if (message.mentions.users.size === 0) return;

            const g = getStreakGuild(message.guild.id);
            const today = vnDateString();
            const authorId = message.author.id;

            for (const code of Object.keys(g.groups)) {
                const group = g.groups[code];
                if (!group.members.includes(authorId)) continue;

                if (group.progressDate !== today) {
                    group.progress = {};
                    group.progressDate = today;
                }
                if (!group.progress) group.progress = {};
                for (const uid of group.members) {
                    if (!group.progress[uid]) group.progress[uid] = { sent: false, received: false };
                }

                let changed = false;
                for (const [mentionedId] of message.mentions.users) {
                    if (mentionedId === authorId) continue;
                    if (!group.members.includes(mentionedId)) continue;
                    group.progress[authorId].sent = true;
                    group.progress[mentionedId].received = true;
                    changed = true;
                }
                if (changed) saveStreaksData();
            }
        } catch (e) {
            console.error('[Streaks] Lỗi theo dõi tin nhắn:', e.message);
        }
    });

    // 6.2: Chốt streak lúc 0h đêm giờ Việt Nam
    cron.schedule('0 0 * * *', async () => {
        console.log('[Streaks] 0h đêm giờ VN - đang chốt streak của tất cả nhóm...');
        const yesterday = vnDateString(-1);
        ...
        for (const guildId of Object.keys(sdb.guilds)) {
            ...
            for (const code of Object.keys(g.groups)) {
                const group = g.groups[code];
                group._guildId = guildId;

                const progress = (group.progressDate === yesterday) ? group.progress : {};
                const allDone = group.members.length >= 2 && group.members.every(uid => {
                    const p = progress[uid];
                    return p && p.sent && p.received;
                });

                const oldStreak = group.streak || 0;
                group.streak = allDone ? oldStreak + 1 : 0;

                group.progress = {};
                group.progressDate = vnDateString();

                if (guild && oldStreak !== group.streak) {
                    for (const uid of group.members) {
                        await applyTierRole(guild, g, uid, group.streak);
                    }
                }
            }
        }
        saveStreaksData();
        console.log('[Streaks] Đã chốt xong streak.');
    }, { timezone: 'Asia/Ho_Chi_Minh' });

    // 6.3: Autocomplete cho "streek" / "groups" / "group"
    client.on('interactionCreate', async (interaction) => {
        if (!interaction.isAutocomplete()) return;
        if (!['setup-streeks', 'watch-stalkers', 'left-the-streets'].includes(interaction.commandName)) return;

        try {
            if (interaction.commandName === 'setup-streeks') {
                const focused = interaction.options.getFocused().toLowerCase();
                const choices = STREAK_TIERS
                    .filter(t => t.label.toLowerCase().includes(focused) || t.key.includes(focused))
                    .slice(0, 25)
                    .map(t => ({ name: t.label, value: t.key }));
                return interaction.respond(choices);
            }

            if (interaction.commandName === 'watch-stalkers' || interaction.commandName === 'left-the-streets') {
                const userGroups = findUserGroups(interaction.user.id);
                const choices = userGroups.slice(0, 25).map(({ guildId, code, group }) => ({
                    name: `${group.name} — chuỗi ${group.streak} ngày (mã ${code})`,
                    value: `${guildId}:${code}`
                }));
                return interaction.respond(choices.length ? choices : [{ name: 'Bạn chưa tham gia nhóm streak nào', value: 'none' }]);
            }
        } catch (e) {
            console.error('[Streaks] Lỗi autocomplete:', e.message);
        }
    });

    // 6.4: Xử lý slash commands
    client.on('interactionCreate', async (interaction) => {
        if (!interaction.isChatInputCommand()) return;
        if (!['setup-streeks', 'streak-request', 'watch-stalkers', 'left-the-streets', 'join-group'].includes(interaction.commandName)) return;

        try {
            // ===== /setup-streeks =====
            if (interaction.commandName === 'setup-streeks') {
                if (!interaction.memberPermissions.has(PermissionsBitField.Flags.Administrator)) {
                    return interaction.reply({ content: '⛔ Chỉ Owner/Admin server mới dùng được lệnh này.', ephemeral: true });
                }
                const role = interaction.options.getRole('role');
                const tierKey = interaction.options.getString('streek');
                const tier = STREAK_TIERS.find(t => t.key === tierKey);
                if (!tier) return interaction.reply({ content: '⚠️ Mốc streak không hợp lệ.', ephemeral: true });

                const g = getStreakGuild(interaction.guild.id);
                g.roleMap[tier.key] = role.id;
                saveStreaksData();

                return interaction.reply({
                    content: `✅ Đã gán role ${role} cho mốc **${tier.label}**.`,
                    ephemeral: true
                });
            }

            // ===== /streak-request =====
            if (interaction.commandName === 'streak-request') {
                const name = interaction.options.getString('name');
                const hostId = interaction.user.id;
                const joiners = new Set([hostId]);

                const embed = new EmbedBuilder()
                    .setColor('#ff5c8a')
                    .setTitle(`🔥 Lời mời lập nhóm Streaks: ${name}`)
                    .setDescription(`Chủ nhóm: <@${hostId}>\n\nBấm **Tham Gia** để vào nhóm (tối thiểu 2 người). Chủ nhóm bấm **Hoàn Tất** khi đủ người.`)
                    .addFields({ name: 'Thành viên đã tham gia', value: `<@${hostId}>` });

                const row = new ActionRowBuilder().addComponents(
                    new ButtonBuilder().setCustomId('streak_join').setLabel('✅ Tham Gia').setStyle(ButtonStyle.Success),
                    new ButtonBuilder().setCustomId('streak_finish').setLabel('🏁 Hoàn Tất').setStyle(ButtonStyle.Primary),
                    new ButtonBuilder().setCustomId('streak_cancel').setLabel('❌ Hủy').setStyle(ButtonStyle.Danger)
                );

                const msg = await interaction.reply({ embeds: [embed], components: [row], fetchReply: true });

                if (!client._streakRequests) client._streakRequests = new Map();
                client._streakRequests.set(msg.id, { hostId, name, joiners, guildId: interaction.guild.id });
                return;
            }

            // ===== /watch-stalkers =====
            if (interaction.commandName === 'watch-stalkers') {
                const val = interaction.options.getString('groups');
                if (val === 'none') return interaction.reply({ content: 'Bạn chưa tham gia nhóm streak nào.', ephemeral: true });
                const [guildId, code] = val.split(':');
                const g = sdb.guilds[guildId];
                const group = g && g.groups[code];
                if (!group) return interaction.reply({ content: '⚠️ Không tìm thấy nhóm này (có thể đã bị xóa).', ephemeral: true });
                group._guildId = guildId;
                return interaction.reply({ embeds: [buildGroupEmbed(group, code)], ephemeral: true });
            }

            // ===== /left-the-streets =====
            if (interaction.commandName === 'left-the-streets') {
                const val = interaction.options.getString('group');
                if (val === 'none') return interaction.reply({ content: 'Bạn chưa tham gia nhóm streak nào.', ephemeral: true });
                const [guildId, code] = val.split(':');
                const g = sdb.guilds[guildId];
                const group = g && g.groups[code];
                if (!group) return interaction.reply({ content: '⚠️ Không tìm thấy nhóm này.', ephemeral: true });

                group.members = group.members.filter(id => id !== interaction.user.id);
                delete group.progress?.[interaction.user.id];

                if (group.members.length < 2) {
                    delete g.groups[code];
                    saveStreaksData();
                    return interaction.reply({ content: `👋 Bạn đã rời nhóm **${group.name}**. Nhóm không còn đủ 2 người nên đã bị giải tán.`, ephemeral: true });
                }

                saveStreaksData();
                return interaction.reply({ content: `👋 Bạn đã rời nhóm **${group.name}**. Muốn tham gia lại, hãy nhờ ai đó trong nhóm dùng \`/join-group code:${code}\` để mời bạn.`, ephemeral: true });
            }

            // ===== /join-group =====
            if (interaction.commandName === 'join-group') {
                const code = interaction.options.getString('code').trim();
                const g = getStreakGuild(interaction.guild.id);
                const group = g.groups[code];
                if (!group) return interaction.reply({ content: '⚠️ Mã mời không hợp lệ hoặc nhóm không thuộc server này.', ephemeral: true });
                if (group.members.includes(interaction.user.id)) {
                    return interaction.reply({ content: 'Bạn đã ở trong nhóm này rồi.', ephemeral: true });
                }
                group.members.push(interaction.user.id);
                saveStreaksData();
                return interaction.reply({ content: `✅ Đã tham gia nhóm **${group.name}**! Chuỗi hiện tại: ${group.streak} ngày.`, ephemeral: true });
            }
        } catch (e) {
            console.error('[Streaks] Lỗi xử lý lệnh:', e);
            if (!interaction.replied && !interaction.deferred) {
                await interaction.reply({ content: '⚠️ Đã xảy ra lỗi ở hệ thống Streaks.', ephemeral: true }).catch(() => {});
            }
        }
    });

    // 6.5: Xử lý nút bấm Tham Gia / Hoàn Tất / Hủy
    client.on('interactionCreate', async (interaction) => {
        if (!interaction.isButton()) return;
        if (!['streak_join', 'streak_finish', 'streak_cancel'].includes(interaction.customId)) return;
        if (!client._streakRequests || !client._streakRequests.has(interaction.message.id)) {
            return interaction.reply({ content: '⚠️ Lời mời này đã hết hạn.', ephemeral: true });
        }

        const state = client._streakRequests.get(interaction.message.id);

        try {
            if (interaction.customId === 'streak_join') {
                if (state.joiners.has(interaction.user.id)) {
                    return interaction.reply({ content: 'Bạn đã tham gia rồi.', ephemeral: true });
                }
                state.joiners.add(interaction.user.id);
                const embed = EmbedBuilder.from(interaction.message.embeds[0])
                    .setFields({ name: 'Thành viên đã tham gia', value: [...state.joiners].map(id => `<@${id}>`).join(', ') });
                await interaction.update({ embeds: [embed] });
                return;
            }

            if (interaction.customId === 'streak_cancel') {
                if (interaction.user.id !== state.hostId) {
                    return interaction.reply({ content: '⛔ Chỉ chủ nhóm mới hủy được lời mời này.', ephemeral: true });
                }
                client._streakRequests.delete(interaction.message.id);
                await interaction.update({ content: '❌ Đã hủy lời mời lập nhóm.', embeds: [], components: [] });
                return;
            }

            if (interaction.customId === 'streak_finish') {
                if (interaction.user.id !== state.hostId) {
                    return interaction.reply({ content: '⛔ Chỉ chủ nhóm mới hoàn tất được.', ephemeral: true });
                }
                if (state.joiners.size < 2) {
                    return interaction.reply({ content: '⚠️ Cần tối thiểu 2 người tham gia trước khi hoàn tất.', ephemeral: true });
                }

                const g = getStreakGuild(state.guildId);
                const code = genGroupCode(state.guildId);
                g.groups[code] = {
                    name: state.name,
                    avatar: null,
                    members: [...state.joiners],
                    streak: 0,
                    progress: {},
                    progressDate: vnDateString(),
                    createdAt: Date.now()
                };
                saveStreaksData();
                client._streakRequests.delete(interaction.message.id);
                ...
                await interaction.update({
                    content: `🎉 Nhóm **${state.name}** đã được tạo!\n**Mã mời nhóm:** \`${code}\`\nDùng \`/join-group code:${code}\` để mời thêm người, hoặc \`/watch-stalkers\` để theo dõi chuỗi.`,
                    embeds: [],
                    components: []
                });
                return;
            ...
            console.error('[Streaks] Lỗi xử lý nút:', e);
        }
    });
}
// ==========================================================
// KẾT THÚC HỆ THỐNG STREAKS
// ==========================================================
...
function dhBuildBettingEmbed(game) {
    ...
    let desc = `<a:emoji_75:1530539512722362508> **ĐUA NGỰA** - Chủ ván: <@${game.hostId}>\n\n`;
    ...
    return new EmbedBuilder()
        .setColor('#e67e22')
        .setTitle('<a:emoji_75:1530539512722362508> TRƯỜNG ĐUA NGỰA <a:emoji_75:1530539512722362508>')
        .setDescription(desc)
...
// Mốc thời gian dùng cho án CHUNG THÂN (tương đương "mãi mãi").
// LƯU Ý: KHÔNG dùng Infinity vì JSON.stringify() sẽ biến Infinity thành null khi lưu file,
// khiến sau khi bot restart hệ thống hiểu nhầm là đã hết hạn và tự thả tù nhân ngay lập tức.
const LIFE_SENTENCE_RELEASE_TIME = Number.MAX_SAFE_INTEGER;
...
// Tạo bộ nhiệm vụ mới với chỉ tiêu RIÊNG cho từng loại (dùng cho /vaotu khi Admin
// nhập số lần khác nhau cho mỗi nhiệm vụ). requiredByKey là object { key: number|null }.
// Nếu 1 nhiệm vụ không được nhập (null/undefined/<=0) thì lấy defaultRequired (mặc định 1).
function buildPrisonTasksCustom(requiredByKey, defaultRequired = 1) {
    const tasks = {};
    for (const t of PRISON_TASKS) {
        const raw = requiredByKey ? requiredByKey[t.key] : null;
        const req = (raw !== null && raw !== undefined && raw > 0) ? raw : defaultRequired;
        tasks[t.key] = { current: 0, required: req };
    }
    return tasks;
}
...
function getGuildData(guildId = 'global') {
    ...
    // Giới hạn số lần !trade / ngày, áp dụng cho TOÀN SERVER (không phải riêng từng user)
    if (!guildData.farm.tradeLimit) guildData.farm.tradeLimit = { count: 0, lockedUntil: 0 };
    // ---------------------------------------------------------
...
// ==========================================
const COMPONENTS = {
    lines: { 'Dây Cước Thường': 200000, 'Dây Cước Bền': 500000, 'Dây Carbon': 1000000, 'Dây Nano': 1500000, 'Dây Titan': 5000000, 'Dây Thiên Hà': 10000000, 'Dây Hư Không': 20000000, 'Dây Vũ Trụ': 50000000 },
    hooks: { 'Lưỡi Câu Sắt': 50000, 'Lưỡi Câu Thép': 200000, 'Lưỡi Câu Bạc': 500000, 'Lưỡi Câu Vàng': 1000000, 'Lưỡi Câu Titan': 3000000, 'Lưỡi Câu Poseidon': 10000000, 'Lưỡi Câu Thần Long': 20000000, 'Lưỡi Câu Sáng Thế': 50000000 },
    floats: { 'Phao Gỗ': 50000, 'Phao Tre': 100000, 'Phao Nhựa': 100000, 'Phao Carbon': 500000, 'Phao Phát Sáng': 300000, 'Phao Hải Thần': 5000000, 'Phao Thiên Hà': 10000000, 'Phao Vũ Trụ': 30000000 },
    reels: { 'Máy Câu Cũ': 1000000, 'Máy Câu Thường': 3000000, 'Máy Câu Chuyên Nghiệp': 10000000, 'Máy Câu Carbon': 20000000, 'Máy Câu Titan': 50000000, 'Máy Câu Hải Đế': 100000000, 'Máy Câu Thần Long': 200000000, 'Máy Câu Omega': 500000000 },
    baits: { 'Trùn Đất': 50000, 'Tôm Nhỏ': 100000, 'Cá Con': 100000, 'Mồi Tổng Hợp': 200000, 'Mồi Phát Sáng': 500000, 'Mồi Đại Dương': 1000000, 'Mồi Huyền Thoại': 5000000, 'Mồi Thần Biển': 10000000 },
    buffs: { 'Bùa May Mắn': 5000000, 'Thuốc Rớt Đồ': 3000000 }
};
...
client.once('clientReady', async (client) => {
        ...
        { 
            ...
            },
            {
                ...
                options: [
                    ...
                    {
                        name: 'phut',
                        description: 'Thời gian thụ án (phút). Bỏ trống = CHUNG THÂN (chỉ được thả khi làm xong hết nhiệm vụ)',
                        type: ApplicationCommandOptionType.Integer,
                        required: false
                    },
                    {
                    ...
                    {
                        name: 'quetrac',
                        description: 'Số lần cần Quét rác 🧹. Bỏ trống = mặc định 1',
                        type: ApplicationCommandOptionType.Integer,
                        required: false
                    },
                    {
                        name: 'trongrau',
                        description: 'Số lần cần Trồng rau 🌱. Bỏ trống = mặc định 1',
                        type: ApplicationCommandOptionType.Integer,
                        required: false
                    },
                    {
                        name: 'vesinh',
                        description: 'Số lần cần Vệ sinh nhà vệ sinh 🧻. Bỏ trống = mặc định 1',
                        type: ApplicationCommandOptionType.Integer,
                        required: false
                    },
                    {
                        name: 'choheoan',
                        description: 'Số lần cần Cho heo ăn 🐷. Bỏ trống = mặc định 1',
                        type: ApplicationCommandOptionType.Integer,
                        required: false
                    },
                    {
                        name: 'ruabat',
                        description: 'Số lần cần Rửa bát 🍽️. Bỏ trống = mặc định 1',
                        type: ApplicationCommandOptionType.Integer,
                        required: false
                    },
                    {
                        name: 'giatdo',
                        description: 'Số lần cần Giặt đồ 👕. Bỏ trống = mặc định 1',
                        type: ApplicationCommandOptionType.Integer,
                        required: false
                    }
                ]
    ...
    options: [
        ...
        },
        {
            ...
            {
                name: 'summon-the-weather',
                description: 'Lệnh Chủ Bot: Triệu hồi thời tiết đặc biệt (x2-x3 giá bán) trên TẤT CẢ server đang dùng bot',
                default_member_permissions: '8',
                options: [
                    {
                        name: 'weathers',
                        description: 'Chọn loại thời tiết đặc biệt muốn triệu hồi',
                        type: ApplicationCommandOptionType.String,
                        required: true,
                        choices: SPECIAL_WEATHER_TYPES.map(w => ({ name: `${w.emoji} ${w.name} (giá bán x${w.sellMult})`, value: w.id }))
                    },
                    {
                        name: 'maintain',
                        description: 'Số phút duy trì thời tiết này trước khi trở lại bình thường',
                        type: ApplicationCommandOptionType.Integer,
                        required: true
                    }
                ]
            ...
            {
                name: 'server-working',
                description: 'Chỉ dành cho Chủ Bot: Xem danh sách server bot đang hoạt động',
                default_member_permissions: '8',
                options: []
            },
            {
                name: 'ban-server',
                description: 'Chỉ Chủ Bot: Ban và auto rời khỏi server',
                default_member_permissions: '8',
                options: [
                    { 
                        name: 'server_id', 
                        description: 'Gõ để tìm tên server bot đang tham gia', 
                        type: ApplicationCommandOptionType.String, 
                        required: true, 
                        autocomplete: true 
                    }
            ...
            {
                name: 'unban-server',
                description: 'Chỉ Chủ Bot: Gỡ ban server đã bị cấm',
                default_member_permissions: '8',
                options: [
                    { 
                        name: 'server_id', 
                        description: 'Gõ để tìm tên server muốn gỡ ban', 
                        type: ApplicationCommandOptionType.String, 
                        required: true, 
                        autocomplete: true 
                    }
...
client.on('messageCreate', async (message) => {
    ...
    if (guildData.prisonUsers && guildData.prisonUsers[userId]) {
        ...
        if (taskCmdMap[fullMsg]) {
            ...
            if (currentTask.current >= currentTask.required) {
                return message.reply(`<a:emoji_73:1530539000748708012>Bạn đã hoàn thành hạn ngạch của công việc **${taskName}** rồi, hãy làm các công việc khác còn thiếu!\n📋 Gõ \`!nhiemvu\` để xem lại bảng nhiệm vụ.`);
            }
    ...
    if (command === 'kho' || command === 'profile') {
        ...
        const equipableItems = Object.keys(user.inventory).filter(item =>
            COMPONENTS.lines[item] || COMPONENTS.hooks[item] || COMPONENTS.floats[item] || COMPONENTS.reels[item] || COMPONENTS.baits[item] || RODS[item]
        ).slice(0, 25);
        ...
        if (equipableItems.length > 0) {
            const options = equipableItems.map(item => {
                ...
                if (RODS[item]) icon = '';
                return {
                    label: (icon ? `${icon} ${item}` : item).slice(0, 100),
                    description: RODS[item] ? `Cần dự phòng: ${user.inventory[item]} cây (Bền gốc: ${RODS[item].dur})` : `Đang có: ${user.inventory[item]} cái`,
                    value: `equip_${item}`
                };
            });
    ...
    if (command === 'caro') {
        ...
        if (!opponent || opponent.bot || opponent.id === userId) return message.reply("<a:emoji_73:1530539023376842762>Bạn phải tag một người chơi khác (không phải bot) để thách đấu!");
    ...
    if (command === 'xidach' || command === 'blackjack') {
        ...
        setTimeout(async () => {
            ...
            if (getBalance(game.dealerId, guildId) < totalBet) { 
                ...
                activeGames.xidach = null; 
                return msg.edit({ content: `<a:emoji_73:1530539023376842762>Nhà Cái không đủ tiền bảo hiểm (Cần: ${totalBet}💸). Sòng bị hủy, tiền cược đã được hoàn lại!`, embeds: [], components: [] }).catch(()=>{}); 
            }
...
client.on('interactionCreate', async (interaction) => {
    ...
    // 1. XỬ LÝ GỢI Ý TỰ ĐỘNG (AUTOCOMPLETE) CHO LỆNH BAN/UNBAN
    if (interaction.isAutocomplete()) {
        const focusedValue = interaction.options.getFocused().toLowerCase();
        let choices = [];

        if (interaction.commandName === 'ban-server') {
            // Gợi ý các server bot đang tham gia
            choices = client.guilds.cache.map(g => ({ name: `${g.name} (${g.id})`, value: g.id }));
        } else if (interaction.commandName === 'unban-server') {
            // Gợi ý các server đang nằm trong danh sách cấm
            choices = Object.keys(bannedServers).map(id => ({ name: `Server ID: ${id}`, value: id }));
        }
    ...
    // 2. XỬ LÝ LOGIC KHI CHẠY LỆNH (isChatInputCommand)
    if (interaction.isChatInputCommand()) {
        const { commandName, user } = interaction;
        const isOwner = OWNER_IDS.includes(user.id);

        if (commandName === "server-working") {
            if (!isOwner) return interaction.reply({ content: "❌ Chỉ Chủ Bot mới được dùng lệnh này!", ephemeral: true });
            
            const guilds = client.guilds.cache.map(g => `Tên: **${g.name}** | ID: \`${g.id}\` | Mem: ${g.memberCount}`);
            const replyText = guilds.length > 0 ? guilds.join("\n") : "Bot chưa tham gia server nào.";
            return interaction.reply({ content: `✅ **Danh sách Server:**\n\n${replyText.substring(0, 1900)}`, ephemeral: true });
        }

        if (commandName === "ban-server") {
            if (!isOwner) return interaction.reply({ content: "❌ Chỉ Chủ Bot mới được dùng lệnh này!", ephemeral: true });
            
            const targetGuildId = interaction.options.getString("server_id");
            bannedServers[targetGuildId] = { timestamp: Date.now() };
            saveBannedServers();

            await interaction.reply({ content: `✅ Đã đưa Server ID \`${targetGuildId}\` vào Blacklist!`, ephemeral: true });

            // Ép bot văng khỏi server
            const targetGuild = client.guilds.cache.get(targetGuildId);
            if (targetGuild) {
                await targetGuild.leave().catch(() => {});
            }
            return; // Dừng lại ở đây, không chạy xuống các lệnh minigame bên dưới nữa
        }

        if (commandName === "unban-server") {
            if (!isOwner) return interaction.reply({ content: "❌ Chỉ Chủ Bot mới được dùng lệnh này!", ephemeral: true });
            
            const targetGuildId = interaction.options.getString("server_id");
            if (bannedServers[targetGuildId]) {
                delete bannedServers[targetGuildId];
                saveBannedServers();
                return interaction.reply({ content: `✅ Đã gỡ lệnh cấm cho Server ID \`${targetGuildId}\`!`, ephemeral: true });
            } else {
                return interaction.reply({ content: `⚠️ Server này không có trong Blacklist.`, ephemeral: true });
            }
        }
...
if (commandName === 'setup-pool') {
    ...
    saveData();
    return interaction.reply({ content: `<a:emoji_73:1530539000748708012> Đã thêm vào mốc **${rarity}**:\n- ${added.join('\n- ')}`, ephemeral: true });
}
...
if (commandName === 'capquyenkenh') {
    ...
    return interaction.reply({ 
        content: `<a:emoji_73:1530539000748708012>**Thiết lập hệ thống tù giam thành công!**\n📍 Kênh cải tạo: <#${nhaTuChannel.id}>\n🎭 Role tù nhân: <@&${prisonRole.id}>`, 
        ephemeral: true 
    });
}
...
if (commandName === 'trano') {
    if (!guildData.debts || !guildData.debts[userId]) {
        return interaction.reply({ content: '<a:emoji_73:1530539000748708012>Hồ sơ trong sạch! Bạn hiện không có khoản nợ tín dụng đen nào.', ephemeral: true });
    }
    ...
    const embed = new EmbedBuilder()
        .setColor('#2ecc71')
        .setTitle('<a:emoji_73:1530539000748708012>THANH TOÁN NỢ THÀNH CÔNG')
...
if (commandName === 'doino') {
    ...
    if (!debts || Object.keys(debts).length === 0) {
        return interaction.reply({ content: '<a:emoji_73:1530539000748708012>Hiện tại server không có ai đang vay nặng lãi cả. Không cần đòi!', ephemeral: true });
    }
    ...
    return interaction.reply({ content: `🔔 **Kêu gọi:** ${pings.join(', ')}`, embeds: [embed] });
            ...
            if (commandName === 'vaotu') {
                ...
                const targetUser = options.getUser('user');
                const targetId = targetUser.id;
                const phutInput = options.getInteger('phut'); // Bỏ trống -> CHUNG THÂN
                const isLifeSentence = (phutInput === null || phutInput === undefined);
                const lyDo = options.getString('ly_do') || 'Vi phạm nội quy server';

                if (!isLifeSentence && phutInput <= 0) {
                    return interaction.reply({ content: '❌ Thời gian thụ án phải lớn hơn 0 phút (hoặc bỏ trống để tống giam CHUNG THÂN)!', ephemeral: true });
                }
                ...
                // 2.5. Lấy số lần làm nhiệm vụ RIÊNG cho từng loại (nếu Admin có nhập),
                // nhiệm vụ nào không nhập sẽ mặc định là 1 lần
                const requiredByKey = {
                    quet_rac:   options.getInteger('quetrac'),
                    trong_rau:  options.getInteger('trongrau'),
                    ve_sinh:    options.getInteger('vesinh'),
                    cho_heo_an: options.getInteger('choheoan'),
                    rua_bat:    options.getInteger('ruabat'),
                    giat_do:    options.getInteger('giatdo')
                };
                ...
                // Chung thân -> releaseTime = Infinity, chỉ được thả khi hoàn thành hết nhiệm vụ
                guildData.prisonUsers[targetId] = {
                    releaseTime: isLifeSentence ? LIFE_SENTENCE_RELEASE_TIME : (Date.now() + (phutInput * 60 * 1000)),
                    reason: lyDo,
                    lifeSentence: isLifeSentence,
                    tasks: buildPrisonTasksCustom(requiredByKey, 1)
                };
                saveData();
            ...
            if (commandName === 'buff') {
                if (user.id !== ADMIN_ID) return interaction.reply({ content: '<a:emoji_73:1530539023376842762>Bạn không có quyền sử dụng lệnh này!', ephemeral: true });
                const targetUser = options.getUser('user'); 
            ...
            if (commandName === 'give') {
                const targetUser = options.getUser('user');
                const amount = options.getInteger('money');
                if (amount <= 0 || getBalance(user.id, guildId) < amount) return interaction.reply({ content: '<a:emoji_73:1530539023376842762>Số tiền không hợp lệ hoặc bạn không đủ số dư!', ephemeral: true });
            ...
            if (commandName === 'sell') {
                const isAdmin = interaction.member.permissions.has(PermissionsBitField.Flags.Administrator) || interaction.guild.ownerId === user.id;
                if (!isAdmin) {
                    return interaction.reply({ content: '<a:emoji_73:1530539023376842762>Chỉ Chủ Server hoặc Admin mới có thể sử dụng lệnh này!', ephemeral: true });
                }
                ...
                return interaction.reply({ 
                    content: `<a:emoji_73:1530539000748708012>  Thành công! Bạn đã đặt bán role <@&${role.id}> tại cửa hàng của server này.\n💸 Mức giá: **${price.toLocaleString()} VNĐ**\n📦 Mã hàng hóa: \`${code}\``, 
                    ephemeral: true 
                });
            }
        }
...
if (interaction.isModalSubmit()) {
    if (interaction.customId.startsWith('modal_buy_') && CHEST_CONFIG[interaction.customId.replace('modal_buy_', '')]) {
        ...
        return interaction.reply({ content: `<a:emoji_73:1530539000748708012> Đã mua **${qty}x ${CHEST_CONFIG[chestId].name}** thành công! Dùng lệnh \`!moruong\` để mở.`, ephemeral: true });
    }
}
                 if (interaction.isButton()) {
    ...
    return;
            ...
            if (id.startsWith('tetris_')) {
                ...
                if (!game) return interaction.reply({ content: '<a:emoji_73:1530539023376842762>Ván game này đã kết thúc hoặc không tồn tại!', ephemeral: true });
            ...
            // GAME BẦU CUA
            if (id === 'bc_btn_join') {
                if (!activeGames.baucua || activeGames.baucua.status !== 'betting') return interaction.reply({ content: '<a:emoji_73:1530539023376842762>Sòng đã đóng hoặc đang lắc!', ephemeral: true });
            ...
            if (id.startsWith('pvp_') || id.startsWith('dealer_')) {
                ...
                if (id === 'pvp_xd_join') {
                    if (xd.status !== 'waiting') return interaction.reply({ content: '<a:emoji_73:1530539023376842762>Sòng đã đóng đăng ký!', ephemeral: true });
                    if (userId === xd.dealerId) return interaction.reply({ content: '<a:emoji_73:1530539023376842762>Bạn là Nhà Cái!', ephemeral: true });
                    if (xd.players.some(p => p.id === userId)) return interaction.reply({ content: '<a:emoji_73:1530539023376842762>Đã có mặt trên bàn!', ephemeral: true });
                ...
                if (id === 'pvp_xd_check') {
                    if (xd.status !== 'players_turn') return interaction.reply({ content: '<a:emoji_73:1530539023376842762>Sai giai đoạn thao tác!', ephemeral: true });
                    const player = xd.players.find(p => p.id === userId);
                    if (!player) return interaction.reply({ content: '<a:emoji_73:1530539023376842762>Bạn không ở trong sòng này!', ephemeral: true });
                    return sendPvpPrivateMenu(interaction, player);
                }

                if (id === 'pvp_hit') {
                    if (xd.status !== 'players_turn') return interaction.reply({ content: '<a:emoji_73:1530539023376842762>Sai giai đoạn chơi!', ephemeral: true });
                    const player = xd.players.find(p => p.id === userId);
                    if (!player || player.status !== 'playing') return interaction.reply({ content: '<a:emoji_73:1530539023376842762>Lỗi hệ thống.', ephemeral: true });
                ...
                if (id === 'pvp_stand') {
                    const player = xd.players.find(p => p.id === userId);
                    if (!player || player.status !== 'playing') return interaction.reply({ content: '<a:emoji_73:1530539023376842762>Lỗi thao tác.', ephemeral: true });
                    player.status = 'stand';
                ...
                if (id === 'dealer_hit') {
                    if (userId !== xd.dealerId) return interaction.reply({ content: '<a:emoji_73:1530539023376842762>Bạn không phải Nhà Cái!', ephemeral: true });
        ...
        if (interaction.isStringSelectMenu()) {
            ...
            if (id === 'bc_select_choice') {
                if (!activeGames.baucua || activeGames.baucua.status !== 'betting') return interaction.update({ content: '<a:emoji_73:1530539023376842762>Ván đã đóng cửa cược!', components: [] });
    ...
    return interaction.reply({ 
        ...
        ephemeral: true 
            ...
            if (id === 'modal_rolebuy') {
                ...
                if (!item) return interaction.reply({ content: '<a:emoji_73:1530539023376842762>Giao dịch thất bại: Mã số không tồn tại trong cửa hàng của server này!', ephemeral: true });
                const price = item.price;
                
                if (getBalance(userId, guildId) < price) return interaction.reply({ content: '<a:emoji_73:1530539023376842762>Giao dịch thất bại: Số dư trong tài khoản bạn không đủ.', ephemeral: true });
                
                const role = interaction.guild.roles.cache.get(item.roleId);
                if (!role) return interaction.reply({ content: '<a:emoji_73:1530539023376842762>Giao dịch thất bại: Role này không còn tồn tại trên server, vui lòng báo Admin!', ephemeral: true });

                const member = await interaction.guild.members.fetch(userId).catch(() => interaction.member);
                if (member.roles.cache.has(role.id)) {
                    return interaction.reply({ 
                        content: `<a:emoji_73:1530539000748708012>  Giao dịch hoàn tất: Bạn đã có sẵn role <@&${role.id}> rồi nên bot không cấp lại và không trừ tiền.`, 
                        ephemeral: true 
                    });
                }
                ...
                try {
                    ...
                    return interaction.reply({ 
                        content: `<a:emoji_73:1530539000748708012>  Giao dịch thành công! Bạn đã mua thành công role <@&${role.id}> với giá **${price.toLocaleString()} VNĐ💸**.`, 
                        ephemeral: true 
                    });
                } catch (err) {
                    console.error('Lỗi khi cấp role:', err);
                    return interaction.reply({ content: '<a:emoji_73:1530539023376842762>Giao dịch thất bại: Bot không có đủ quyền ưu tiên để cấp role này. Vui lòng liên hệ Admin!', ephemeral: true });
                }
            }

            // MODAL TÀI XỈU
            if (id.startsWith('modal_tx_bet_')) {                          
                if (!activeGames.taixiu || activeGames.taixiu.status !== 'betting') return interaction.reply({ content: '<a:emoji_73:1530539023376842762>Đã hết giờ!', ephemeral: true });
                const hasBetted = activeGames.taixiu.bets.some(b => b.userId === userId);
                if (hasBetted) return interaction.reply({ content: '<a:emoji_73:1530539023376842762>Bạn đã đặt cược trong ván này rồi, mỗi ván chỉ được chọn 1 cửa!', ephemeral: true });

                const choice = id.replace('modal_tx_bet_', '');
                const amount = parseInt(interaction.fields.getTextInputValue('tx_amount_input'));                                                                           
                if (isNaN(amount) || amount < 10) return interaction.reply({ content: '<a:emoji_73:1530539023376842762>Tối thiểu 10 VNĐ!', ephemeral: true });
                if (getBalance(userId, guildId) < amount) return interaction.reply({ content: '<a:emoji_73:1530539023376842762>Số dư tài khoản không đủ!', ephemeral: true });
                ...
                await interaction.reply({ content: `<a:emoji_73:1530539000748708012>  Đặt cược thành công **${amount}💸** vào cửa **${choiceName}**!`, ephemeral: true });
                return activeGames.taixiu.mainMessage.edit({ embeds: [updateEmbed] }).catch(()=>{});
            }

            // MODAL BẦU CUA
            if (id.startsWith('modal_bc_bet_')) {
                if (!activeGames.baucua || activeGames.baucua.status !== 'betting') return interaction.reply({ content: '<a:emoji_73:1530539023376842762>Đã hết giờ!', ephemeral: true });
                ...
                await interaction.reply({ content: `<a:emoji_73:1530539000748708012>  Đặt cược thành công **${amount}💸** vào **${choice}**!`, ephemeral: true });
                return activeGames.baucua.mainMessage.edit({ embeds: [updateEmbed] }).catch(()=>{});
            }
            // MODAL XÌ DÁCH
            if (id === 'modal_pvp_bet') {
                const game = activeGames.xidach;
                if (!game || game.status !== 'waiting') return interaction.reply({ content: '<a:emoji_73:1530539023376842762>Đã đóng cửa sòng!', ephemeral: true });
                
                const bet = parseInt(interaction.fields.getTextInputValue('pvp_bet_input'));
                if (isNaN(bet) || bet < 10) return interaction.reply({ content: '<a:emoji_73:1530539023376842762>Tối thiểu 10 VNĐ!', ephemeral: true });
                if (getBalance(userId, guildId) < bet) return interaction.reply({ content: '<a:emoji_73:1530539023376842762>Tài khoản không đủ!', ephemeral: true });
                ...
                await interaction.reply({ content: `<a:emoji_73:1530539000748708012>  Vô cược **${bet}💸** thành công!`, ephemeral: true });
        ...
        if (!interaction.replied && !interaction.deferred) {
            await interaction.reply({ content: '<a:emoji_73:1530539023376842762>Đã xảy ra lỗi hệ thống khi xử lý tương tác này.', ephemeral: true }).catch(() => {});
        }
    }
});
    ...
    try {
        ...
        if (interaction.isModalSubmit()) {
            if (interaction.customId.startsWith('modal_buy_')) {
                ...
                saveFishingData();
                return interaction.reply({ content: `<a:emoji_73:1530539000748708012> Mua thành công **${quantity}x ${itemName}** với tổng giá **${totalPrice.toLocaleString()} VNĐ**!`, ephemeral: true });
            }
        }
        ...
        if (interaction.isStringSelectMenu()) {
            if (interaction.customId === 'menu_trangbi') {
                ...
                for (const item of items) {
                    ...
                    if (RODS[item]) {
                        const oldRod = user.equip.rod;
                        if (oldRod && oldRod !== item) user.inventory[oldRod] = (user.inventory[oldRod] || 0) + 1;
                        user.equip.rod = item;
                        user.equip.rodPlus = 0;
                        user.equip.dur = RODS[item].dur;
                ...
                saveFishingData();
                return interaction.reply({ content: `<a:emoji_73:1530539000748708012> Bạn đã lắp thành công các trang bị sau vào cần câu:\n${equippedLog.join(', ')}`, ephemeral: true });
            }
            ...
            if (interaction.customId === 'menu_ruong') {
                ...
                user.maxInv += addSlot;
                saveFishingData();
                return interaction.reply({ content: `<a:emoji_73:1530539000748708012> Nâng cấp thành công! Kho hiện tại chứa được tối đa **${user.maxInv}** slots.`, ephemeral: true });
            }
            ...
            if (interaction.customId === 'menu_shopcan_buy') {
                ...
                if (oldRod && oldRod !== rodName) user.inventory[oldRod] = (user.inventory[oldRod] || 0) + 1;
                user.equip.rod = rodName; user.equip.rodPlus = 0; user.equip.dur = rodData.dur;
                saveFishingData();
                const storedText = (oldRod && oldRod !== rodName) ? ` Cần cũ **${oldRod}** đã được cất vào Kho Đồ (dùng \`!kho\` để trang bị lại).` : '';
                return interaction.reply({ content: `<a:emoji_73:1530539000748708012> Bạn đã mua sắm và trang bị lập tức **${rodName}** với giá **${rodData.price.toLocaleString()} VNĐ**!${storedText}`, ephemeral: true });
            }
            ...
            if (interaction.customId === 'menu_update_rod') {
                ...
                saveFishingData();
                const storedText = (oldRod && oldRod !== rodName) ? ` Cần cũ **${oldRod}** đã được cất vào Kho Đồ.` : '';
                return interaction.reply({ content: `⚒️ Vang dội tiếng búa! Bạn đã rèn và tự động khoác lên người thần binh: 🎉 **${rodName}**!${storedText}`, ephemeral: true });
            }
        }
    } catch (error) {
        console.error('Lỗi khi xử lý câu cá:', error);
        if (!interaction.replied && !interaction.deferred) {
            await interaction.reply({ content: '<a:emoji_73:1530539023376842762>Đã xảy ra lỗi hệ thống khi xử lý câu cá.', ephemeral: true }).catch(() => {});
        }
    }
});
    ...
    try {
        ...
        if (interaction.isChatInputCommand() && interaction.commandName === 'tudev') {
            ...
            if (sub === 'give_item') {
                ...
                saveData();
                return interaction.reply({ content: `<a:emoji_73:1530539000748708012> Đã cấp **${amount}x ${itemId}** cho <@${target.id}>.`, ephemeral: true });
            }
            ...
            if (sub === 'set_stats') {
                ...
                saveData();
                return interaction.reply({ content: `<a:emoji_73:1530539000748708012> Đã set **${loai}** của <@${target.id}> thành **${amount.toLocaleString()}**.`, ephemeral: true });
            }
        ...
        if (interaction.isChatInputCommand() && interaction.commandName === 'tuconfig') {
            ...
            if (sub === 'bind_channel') {
                ...
                saveData();
                return interaction.reply({ content: `<a:emoji_73:1530539000748708012> Thông báo Đột Phá/PK Tu Tiên sẽ được gửi vào <#${channel.id}>.`, ephemeral: true });
            }
            ...
            if (sub === 'bind_role') {
                ...
                saveData();
                return interaction.reply({ content: `<a:emoji_73:1530539000748708012> Member đột phá lên **${canhGioi}** sẽ tự động nhận role <@&${role.id}>.`, ephemeral: true });
            }
            ...
            if (sub === 'reset_cooldown') {
                ...
                saveData();
                return interaction.reply({ content: `<a:emoji_73:1530539000748708012> Đã reset cooldown Tu Tiên cho <@${target.id}>.`, ephemeral: true });
            }
        }

        // --- SLASH COMMAND: /summon-the-weather (Chỉ Chủ Bot) ---
        // Triệu hồi 1 thời tiết ĐẶC BIỆT (x2-x3 giá bán) và áp dụng lên TẤT CẢ server bot đang có mặt,
        // kể cả những server khác nơi bot được add mà Chủ Bot không gõ lệnh trực tiếp trong đó.
        if (interaction.isChatInputCommand() && interaction.commandName === 'summon-the-weather') {
            if (!TT_OWNER_IDS.includes(userId)) {
                return interaction.reply({ content: '❌ Chỉ Chủ Bot mới được dùng lệnh này!', ephemeral: true });
            }
            const weatherId = interaction.options.getString('weathers');
            const minutes = interaction.options.getInteger('maintain');
            const weatherData = WEATHER_TYPES.find(w => w.id === weatherId);
            if (!weatherData) return interaction.reply({ content: '❌ Không tìm thấy loại thời tiết này!', ephemeral: true });
            if (minutes <= 0) return interaction.reply({ content: '❌ Thời gian duy trì phải lớn hơn 0 phút!', ephemeral: true });

            const until = Date.now() + minutes * 60000;
            let affected = 0;
            for (const guild of client.guilds.cache.values()) {
                const gd = getGuildData(guild.id);
                gd.farm.weather = { current: weatherData.id, changedAt: Date.now(), forcedUntil: until };
                affected++;
            }
            saveData();

            // Tự động trả lại thời tiết bình thường ngay khi hết hạn, không cần chờ mốc cron hàng giờ
            setTimeout(() => {
                for (const guild of client.guilds.cache.values()) {
                    const gd = getGuildData(guild.id);
                    if (gd.farm.weather?.forcedUntil === until) {
            ...
            return interaction.reply({ content: `${weatherData.emoji} Đã triệu hồi thời tiết **${weatherData.name}** (giá bán x${weatherData.sellMult || 1}) trên **${affected} server** trong **${minutes} phút**!`, ephemeral: true });
        }
        ...
        if (interaction.isStringSelectMenu() && interaction.customId.startsWith('tt_menu_')) {
            ...
            if (interaction.customId === 'tt_menu_muahang') {
                ...
                saveData();
                return interaction.reply({ content: `<a:emoji_73:1530539000748708012> Đã mua **1x ${item.name}** với giá **${item.price.toLocaleString()} Linh Thạch**.`, ephemeral: true });
            }
        }
...
const CROPS = {
    ...
    luami: { name: 'Lúa Mì', emoji: '🌾', seedPrice: 12000, growTime: 12 * 60000, sellPrice: 20000 }
};
...
const ANIMALS = {
    ...
    ong: { name: 'Ong', emoji: '🐝', price: 350000, prodTime: 4 * 3600000, product: 'mat_ong', productName: 'Mật Ong', productEmoji: '🍯', productPrice: 90000 },
    tho: { name: 'Thỏ', emoji: '🐇', price: 250000, prodTime: 5 * 3600000, product: 'long_tho', productName: 'Lông Thỏ', productEmoji: '🧵', productPrice: 70000 }
};
...
const RECIPES = {
    ...
    // --- Món cần nhiều loại nguyên liệu ---
    banh_kem: { name: 'Bánh Kem', emoji: '🎂', need: { luami: 3, sua_bo: 2, trung_ga: 2 }, time: 20 * 60000, sellPrice: 400000, energy: 420 },
    banh_mat_ong: { name: 'Bánh Mật Ong', emoji: '🍯', need: { luami: 2, mat_ong: 2 }, time: 12 * 60000, sellPrice: 220000, energy: 300 }
};
...
const WEATHER_TYPES = [
    { id: 'nang_dep', name: 'Nắng đẹp', emoji: '☀️', chance: 30.5, speedMult: 1.10 },
    ...
    // --- Thời tiết ĐẶC BIỆT (hiếm, chỉ ~0.15%/lần quay tự nhiên, chủ yếu do Chủ Bot triệu hồi qua /summon-the-weather) ---
    // Các thời tiết này tăng gấp 2-3 lần giá bán gốc (sellMult) để tạo sự kiện "sốt giá" toàn server.
    { id: 'con_sot_vang', name: 'Cơn Sốt Vàng', emoji: '🪙', chance: 0.15, speedMult: 1.0, sellMult: 2, special: true, beneficial: true },
    { id: 'sieu_trang', name: 'Siêu Trăng', emoji: '🌝', chance: 0.15, speedMult: 1.1, sellMult: 1.5, mutateBonus: 0.1, special: true, beneficial: true },
    { id: 'mua_thien_thach', name: 'Mưa Thiên Thạch', emoji: '☄️', chance: 0.15, speedMult: 1.0, sellMult: 3, damageChance: 0.15, special: true },
    { id: 'bang_gia', name: 'Băng Giá', emoji: '❄️', chance: 0.15, speedMult: 0.5, sellMult: 1.5, special: true, harmful: true },
    { id: 'nhat_thuc', name: 'Nhật Thực', emoji: '🌑', chance: 0.15, speedMult: 1.0, sellMult: 2, diseaseMult: 1.5, special: true },
    { id: 'gio_mua_vang', name: 'Gió Mùa Vàng', emoji: '🍂', chance: 0.15, speedMult: 1.3, sellMult: 2, special: true, beneficial: true },
    { id: 'sam_set_ma_thuat', name: 'Sấm Sét Ma Thuật', emoji: '🌩️', chance: 0.15, speedMult: 1.0, sellMult: 2.5, mutateBonus: 0.15, special: true },
    { id: 'hao_quang_than_bi', name: 'Hào Quang Thần Bí', emoji: '🌟', chance: 0.15, speedMult: 1.2, sellMult: 3, special: true, beneficial: true },
    { id: 'bao_cat_vang', name: 'Bão Cát Vàng', emoji: '🏆', chance: 0.15, speedMult: 1.0, sellMult: 2, needWaterOrSlow: true, special: true },
    { id: 'cuc_quang', name: 'Cực Quang', emoji: '🌌', chance: 0.15, speedMult: 1.0, sellMult: 2.5, fishingLuckBonus: true, mutateBonus: 0.1, special: true, beneficial: true }
];
const SPECIAL_WEATHER_TYPES = WEATHER_TYPES.filter(w => w.special);
...
function fmFishItemMeta(itemId) {
    // GHI CHÚ: Cần câu có giá sẵn (RODS[id].price). Cá & nguyên liệu câu cá KHÔNG có giá cụ thể trong data gốc,
    // nên ở đây ước tính sellPrice dựa theo khoảng giá (minPrice-maxPrice) của độ hiếm (rarity tier) tương ứng,
    // dùng để tính chênh lệch giá trị cho !trade. Nguyên liệu (drops) được tính = 30% giá trung bình của cá cùng độ hiếm.
    if (RODS[itemId]) return { name: itemId, emoji: itemId.split(' ')[0], category: 'rod', sellPrice: RODS[itemId].price || 0 };
    for (const r of Object.values(FISH_DATA)) {
        const tierAvgPrice = Math.round((r.minPrice + r.maxPrice) / 2);
        if (r.list.includes(itemId)) return { name: itemId, emoji: '🐟', category: 'fish', sellPrice: tierAvgPrice };
        if (r.drops.includes(itemId)) return { name: itemId, emoji: '🔩', category: 'fish_material', sellPrice: Math.round(tierAvgPrice * 0.3) };
    }
    return { name: itemId, emoji: '📦', category: 'fish_material', sellPrice: 0 };
}
...
function fmMarketPrice(itemId, guildId) {
    ...
    const weather = fmGetWeather(guildId);
    const weatherMult = weather.sellMult || 1;
    return Math.floor(meta.sellPrice * mult * weatherMult);
}
...
function fmRenderPlotGrid(plots, cols = 7) {
    const rows = [];
...
function fmPlotFieldValue(plots, cols = 7) {
...
async function fmRenderPanel(interaction, u, guildId) {
    ...
    const embed = new EmbedBuilder()
        ...
        .setFooter({ text: 'Dùng !shophatgiong, !plant, !thuhoach, !tuoinuoc, !bonphan, !thuocsau, !nangcapnongtrai, !channuoi, !chebien, !an, !nguyenlieu, !cho, !trade' });
...
cron.schedule('0 * * * *', () => {
    try {
        for (const guildId of Object.keys(db.guilds)) {
            const gd = getGuildData(guildId);
            // Nếu đang có thời tiết đặc biệt bị Chủ Bot ép duy trì (/summon-the-weather) và chưa hết hạn thì giữ nguyên
            const isForced = gd.farm.weather?.forcedUntil && gd.farm.weather.forcedUntil > Date.now();
            if (!isForced) {
                const newWeather = ttPickWeather();
                gd.farm.weather = { current: newWeather.id, changedAt: Date.now() };
            }
...
client.on('messageCreate', async (message) => {
    try {
        ...
        if (command === 'nangcapnongtrai') {
            ...
            const desc = Object.entries(FARM_UPGRADE_FLAGS).map(([id, up]) => `**${up.name}**: ${up.desc} (${up.price.toLocaleString()}đ)${u.upgrades[up.flag] ? ' <a:emoji_73:1530539000748708012> Đã sở hữu' : ''}`).join('\n');
            const embed = new EmbedBuilder().setColor('#8e44ad').setTitle('🚜 NÂNG CẤP NÔNG TRẠI').setDescription(desc);
            return message.reply({ embeds: [embed], components: [new ActionRowBuilder().addComponents(menu)] });
        }

        if (['channuoi', 'chanuoi', 'vatnuoi'].includes(command)) {
            const menu = new StringSelectMenuBuilder()
                .setCustomId('fm_menu_channuoi_action')
        ...
        if (['chebien'].includes(command)) {
            ...
            if (doneJobs.length) content = `<a:emoji_73:1530539000748708012> Đã hoàn thành ${doneJobs.length} mẻ chế biến trước đó, vật phẩm đã vào Kho!\n\n` + content;
        ...
        if (['nguyenlieu', 'khonguyenlieu'].includes(command)) {
            const u = fmGetUser(userId, guildId);
            const entries = Object.entries(u.warehouse).filter(([, qty]) => qty > 0);
            const whTotal = entries.reduce((sum, [, qty]) => sum + qty, 0);

            if (!entries.length) {
                return message.reply('🏬 Kho Nguyên Liệu của bạn đang trống trơn! Hãy `!thuhoach` hoặc `!channuoi` để có nguyên liệu nhé.');
            }

            // Gom nhóm theo loại (crop / animal_product / food / medicine / unknown) rồi sắp xếp giảm dần theo số lượng
            const groups = { crop: [], animal_product: [], food: [], medicine: [], unknown: [] };
            for (const [id, qty] of entries.sort((a, b) => b[1] - a[1])) {
                const meta = fmItemMeta(id);
                const line = `${meta.emoji} **${meta.name}**: x${qty.toLocaleString()}`;
                (groups[meta.category] || groups.unknown).push(line);
            }

            const embed = new EmbedBuilder()
                .setColor('#8e5a2b')
                .setAuthor({ name: `Kho Nguyên Liệu của ${message.member.displayName}`, iconURL: message.author.displayAvatarURL() })
                .setTitle('🏬 KHO NGUYÊN LIỆU NÔNG TRẠI')
                .setDescription(`📦 Sức chứa: **${whTotal.toLocaleString()}/${u.warehouseCap.toLocaleString()}**`);

            if (groups.crop.length) embed.addFields({ name: `🌾 Nông Sản (${groups.crop.length})`, value: groups.crop.join('\n').slice(0, 1024), inline: true });
            if (groups.animal_product.length) embed.addFields({ name: `🐄 Sản Phẩm Chăn Nuôi (${groups.animal_product.length})`, value: groups.animal_product.join('\n').slice(0, 1024), inline: true });
            if (groups.food.length) embed.addFields({ name: `🍞 Thức Ăn / Đồ Chế Biến (${groups.food.length})`, value: groups.food.join('\n').slice(0, 1024), inline: true });
            if (groups.medicine.length) embed.addFields({ name: `🧴 Thuốc & Vật Tư (${groups.medicine.length})`, value: groups.medicine.join('\n').slice(0, 1024), inline: true });
            if (groups.unknown.length) embed.addFields({ name: `❓ Khác (${groups.unknown.length})`, value: groups.unknown.join('\n').slice(0, 1024), inline: true });

            embed.setFooter({ text: 'Dùng !bannongsan để bán hoặc !chebien để chế biến nguyên liệu trong Kho' });
            return message.reply({ embeds: [embed] });
        }
        ...
        if (command === 'trade') {
            ...
            const row1 = new ActionRowBuilder().addComponents(
                ...
                new ButtonBuilder().setCustomId(`fm_trade_ready_${sessionId}`).setLabel('Sẵn Sàng').setEmoji('<a:emoji_73:1530539000748708012>').setStyle(ButtonStyle.Success),
...
// ==========================================
// !TRADE: KIỂM SOÁT CHÊNH LỆCH GIÁ TRỊ & GIỚI HẠN SỐ LẦN/NGÀY (TOÀN SERVER)
// ==========================================
const FM_TRADE_MAX_DIFF_PERCENT = 40; // Chênh lệch giá trị tối đa cho phép giữa 2 bên (yêu cầu: mốc 35-40%, lấy 40% làm giới hạn cứng)
const FM_TRADE_DAILY_LIMIT = 3;       // Số lần trade tối đa/ngày, tính CHUNG cho cả server
const FM_TRADE_LOCK_MS = 24 * 60 * 60 * 1000; // Sau khi đạt giới hạn, khóa 24h rồi mới reset lại lượt

// Quy đổi 1 key trong phiên trade ("wh_x" / "seed_x" / "fish_x") ra giá trị VNĐ ước tính
function fmTradeKeyValue(key) {
    const sep = key.indexOf('_');
    const type = key.slice(0, sep);
    const id = key.slice(sep + 1);
    if (type === 'wh') return fmItemMeta(id).sellPrice || 0;
    if (type === 'seed') return Math.round((CROPS[id]?.sellPrice || 0) * 0.5); // Hạt giống ước tính = 50% giá bán nông sản tương ứng
    if (type === 'fish') return fmFishItemMeta(id).sellPrice || 0;
    return 0;
}

function fmTradeOfferValue(offer) {
    return Object.entries(offer).reduce((sum, [key, qty]) => sum + fmTradeKeyValue(key) * qty, 0);
}

// Kiểm tra xem server còn lượt trade trong ngày không (tự reset sau khi hết 24h khóa)
function fmCheckTradeLimit(guildId) {
    const guildData = getGuildData(guildId);
    const tl = guildData.farm.tradeLimit;
    const now = Date.now();
    if (tl.lockedUntil && now >= tl.lockedUntil) { tl.count = 0; tl.lockedUntil = 0; }
    if (tl.count >= FM_TRADE_DAILY_LIMIT) return { allowed: false, remainingMs: tl.lockedUntil - now };
    return { allowed: true };
}

// Gọi SAU KHI 1 giao dịch trade đã thực hiện thành công, để tính vào giới hạn/ngày của server
function fmRegisterTradeUsage(guildId) {
    const guildData = getGuildData(guildId);
    const tl = guildData.farm.tradeLimit;
    tl.count += 1;
    if (tl.count >= FM_TRADE_DAILY_LIMIT) tl.lockedUntil = Date.now() + FM_TRADE_LOCK_MS;
    saveData();
}
...
function fmBuildTradeEmbed(state) {
    ...
    return new EmbedBuilder()
        ...
        .addFields(
            { name: `👤 <@${state.userA}> ${state.ready[state.userA] ? '<a:emoji_73:1530539000748708012>' : '⏳'}`, value: line(state.userA), inline: true },
            { name: `👤 <@${state.userB}> ${state.ready[state.userB] ? '<a:emoji_73:1530539000748708012>' : '⏳'}`, value: line(state.userB), inline: true }
        )
        .setFooter({ text: 'Có thể trao đổi Nông sản, Hạt giống, Đồ chế biến, Sản phẩm chăn nuôi, Cá, Nguyên liệu câu cá & Cần câu dự phòng. Không thể trao đổi Tiền, Thuốc hoặc Máy móc. Cả 2 bên bấm Sẵn Sàng để hoàn tất.' });
}
    ...
    try {
            ...
            if (interaction.customId.startsWith('fm_trade_')) {
                ...
                if (action === 'ready') {
                    ...
                    if (state.ready[state.userA] && state.ready[state.userB]) {
                        ...
                        // --- GIỚI HẠN SỐ LẦN TRADE/NGÀY (TOÀN SERVER) ---
                        const limitCheck = fmCheckTradeLimit(guildId);
                        if (!limitCheck.allowed) {
                            activeGames.trade.delete(tradeKey);
                            const hoursLeft = Math.max(1, Math.ceil(limitCheck.remainingMs / (60 * 60 * 1000)));
                            return chan.send(`⛔ Server đã đạt giới hạn **${FM_TRADE_DAILY_LIMIT} lượt trade/ngày**! Vui lòng chờ khoảng **${hoursLeft} giờ** nữa. Giao dịch đã bị hủy.`);
                        }

                        // --- KIỂM SOÁT CHÊNH LỆCH GIÁ TRỊ GIỮA 2 BÊN ---
                        const valA = fmTradeOfferValue(state.offers[state.userA]);
                        const valB = fmTradeOfferValue(state.offers[state.userB]);
                        const maxVal = Math.max(valA, valB);
                        const diffPercent = maxVal > 0 ? (Math.abs(valA - valB) / maxVal) * 100 : 0;
                        if (diffPercent > FM_TRADE_MAX_DIFF_PERCENT) {
                            state.ready[state.userA] = false;
                            state.ready[state.userB] = false;
                            return chan.send(`⚠️ Chênh lệch giá trị giữa 2 bên đang là **${diffPercent.toFixed(1)}%**, vượt quá mức cho phép (tối đa ${FM_TRADE_MAX_DIFF_PERCENT}%)!\n💰 <@${state.userA}> ≈ ${valA.toLocaleString()}đ | <@${state.userB}> ≈ ${valB.toLocaleString()}đ\nVui lòng điều chỉnh lại vật phẩm rồi bấm Sẵn Sàng lại.`);
                        }
                        ...
                        saveData();
                        activeGames.trade.delete(tradeKey);
                        fmRegisterTradeUsage(guildId);
                        const tlAfter = getGuildData(guildId).farm.tradeLimit;
                        await chan.send(`<a:emoji_73:1530539000748708012> Trao đổi giữa <@${finalState.userA}> và <@${finalState.userB}> đã hoàn tất thành công! (Lượt trade server hôm nay: ${tlAfter.count}/${FM_TRADE_DAILY_LIMIT})`);
                    }
                    return;
                }
            }
        ...
        if (interaction.isStringSelectMenu()) {
            ...
            if (interaction.customId.startsWith('fm_menu_cham_')) {
                ...
                return interaction.reply({ content: `<a:emoji_73:1530539000748708012> Đã áp dụng **${labelMap[flag]}** cho ô ${idx + 1}! (-${ENERGY_CONFIG.costs.cham_soc}kcal, còn ${u.energy}/${u.maxEnergy})${curedText}`, ephemeral: true });
            }
            ...
            if (interaction.customId === 'fm_menu_nangcap') {
                if (value === 'more_plot') {
                    ...
                    u.plotCount++;
                    saveData();
                    return interaction.reply({ content: `<a:emoji_73:1530539000748708012> Đã mở thêm 1 ô đất! Hiện tại bạn có **${u.plotCount} ô**.`, ephemeral: true });
                }
                if (value === 'kho') {
                    ...
                    u.warehouseCap += 50;
                    saveData();
                    return interaction.reply({ content: `<a:emoji_73:1530539000748708012> Nhà kho đã được mở rộng! Sức chứa hiện tại: **${u.warehouseCap}**.`, ephemeral: true });
                }
                ...
                if (up) {
                    ...
                    saveData();
                    return interaction.reply({ content: `<a:emoji_73:1530539000748708012> Đã mua **${up.name}**! ${up.desc}`, ephemeral: true });
                }
            }

            if (interaction.customId === 'fm_menu_channuoi_action') {
                if (value === 'mua') {
                ...
                if (value === 'choan') {
                    ...
                    if (totalNeed === 0) return interaction.reply({ content: '<a:emoji_73:1530539000748708012> Toàn bộ vật nuôi của bạn đã được cho ăn rồi!', ephemeral: true });
        ...
        if (interaction.isModalSubmit()) {
            ...
            if (interaction.customId === 'fm_modal_phanboncc') {
                ...
                saveData();
                return interaction.reply({ content: `<a:emoji_73:1530539000748708012> Đã mua **${qty}x Phân Bón Cao Cấp** với giá **${total.toLocaleString()}đ**, hãy dùng khi Bón Phân để tăng thêm sản lượng!`, ephemeral: true });
            }
            ...
            if (interaction.customId.startsWith('fm_modal_muahat_')) {
                ...
                saveData();
                return interaction.reply({ content: `<a:emoji_73:1530539000748708012> Đã mua **${qty}x hạt ${CROPS[cropId].name}** với giá **${total.toLocaleString()}đ**!`, ephemeral: true });
            }
            ...
            if (interaction.customId.startsWith('fm_modal_muavatnuoi_')) {
                ...
                saveData();
                return interaction.reply({ content: `<a:emoji_73:1530539000748708012> Đã mua **${qty}x ${ANIMALS[animalId].name}** với giá **${total.toLocaleString()}đ**!`, ephemeral: true });
            }
            ...
            if (interaction.customId.startsWith('fm_modal_tradeqty_')) {
                ...
                await interaction.reply({ content: `<a:emoji_73:1530539000748708012> Đã thêm **${qty}x ${displayName}** vào giao dịch!`, ephemeral: true });
                const chan = interaction.channel;
...
client.on('interactionCreate', async (interaction) => {
    try {
        ...
        if (interaction.isModalSubmit() && interaction.customId.startsWith('dh_modal_bet_')) {
            ...
            await interaction.reply({ content: `<a:emoji_73:1530539000748708012> Đã cược **${amount.toLocaleString()}đ** vào ngựa số **${horse}**! Chúc may mắn 🍀`, ephemeral: true });
        ...
        if (interaction.isButton() && interaction.customId === 'dh_start') {
            ...
            for (let t = 0; t < TICKS; t++) {
                ...
                const frameEmbed = new EmbedBuilder()
                    .setColor('#e67e22')
                    .setTitle('<a:emoji_75:1530539512722362508> ĐUA NGỰA ĐANG DIỄN RA... <a:emoji_75:1530539512722362508>')
...
client.on('interactionCreate', async (interaction) => {
    try {
        ...
        if (interaction.isChatInputCommand() && interaction.commandName === 'stock-prices') {
            ...
            if (!isAdmin) {
                return interaction.reply({ content: '<a:emoji_73:1530539023376842762> Chỉ Admin/Chủ server mới được cài đặt kênh chứng khoán!', ephemeral: true });
            }
            ...
            await interaction.reply({ content: `<a:emoji_73:1530539000748708012> Đã đặt kênh cập nhật giá chứng khoán tại ${channel}!`, ephemeral: true });
        ...
        if (interaction.isModalSubmit() && interaction.customId === 'stock_modal_buy') {
            ...
            if (!Number.isInteger(qty) || qty <= 0) {
                return interaction.reply({ content: '<a:emoji_73:1530539023376842762> Số lượng không hợp lệ! Vui lòng nhập số nguyên dương.', ephemeral: true });
            }
            ...
            if (balance < totalCost) {
                return interaction.reply({ content: `<a:emoji_73:1530539023376842762> Số dư không đủ! Bạn cần **${totalCost.toLocaleString()}đ** nhưng chỉ có **${balance.toLocaleString()}đ**.`, ephemeral: true });
            }
            ...
            return interaction.reply({
                content: `<a:emoji_73:1530539000748708012> Đã mua **${qty.toLocaleString()} cổ phiếu** với giá **${price.toLocaleString()}đ/cp** (tổng **${totalCost.toLocaleString()}đ**)!\n📦 Bạn hiện đang sở hữu **${guildData.stock.holdings[userId].toLocaleString()} cổ phiếu**.`,
                ephemeral: true
            });
        }
        ...
        if (interaction.isModalSubmit() && interaction.customId === 'stock_modal_sell') {
            ...
            if (owned < qty) {
                return interaction.reply({ content: `<a:emoji_73:1530539023376842762> Bạn chỉ đang sở hữu **${owned.toLocaleString()} cổ phiếu**, không đủ để bán **${qty.toLocaleString()}**!`, ephemeral: true });
            }
            ...
            return interaction.reply({
                content: `<a:emoji_73:1530539000748708012> Đã bán **${qty.toLocaleString()} cổ phiếu** với giá **${price.toLocaleString()}đ/cp**, nhận về **${totalGain.toLocaleString()}đ**!\n📦 Bạn còn lại **${(guildData.stock.holdings[userId] || 0).toLocaleString()} cổ phiếu**.`,
                ephemeral: true
            });
        }
    } catch (error) {
...
client.on("guildCreate", async (guild) => {
    if (bannedServers[guild.id]) {
        console.log(`[BANNED] Tự động rời khỏi server bị cấm: ${guild.name} (${guild.id})`);
        try {
            // Tùy chọn: Gửi tin nhắn chào tạm biệt trước khi out
            ...
            if (defaultChannel) {
                await defaultChannel.send("❌ Server này đã bị cấm sử dụng bot. Tạm biệt!").catch(() => {});
            }
            await guild.leave();
        } catch (error) {
            console.error(error);
